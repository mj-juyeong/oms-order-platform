...
@Entity
@Table(name = "client_store_route_master_scopes")
class ClientStoreRouteMasterScopeEntity(
	...
	@Column(name = "store_route_master_item_id", nullable = false)
	var storeRouteMasterItemId: Long = 0,
