...
| Method | Path | 설명 | 권한 | Request Body 또는 Query Parameter | Response Body 예시 | Error Case |
|---|---|---|---|---|---|---|
| POST | `/api/v1/masters/products/uploads/preview` | 상품 마스터 CSV 업로드 파일 검사. 현재 마스터에는 아직 반영하지 않음 | ADMIN | Multipart: `file` | `{ "uploadId": 3, "rowCount": 1200, "validCount": 1195, "failedCount": 5, "candidateInsertedCount": 20, "candidateUpdatedCount": 15, "candidateUnchangedCount": 1160, "status": "REVIEW_REQUIRED", "failures": [{ "rowNo": 12, "columnName": "ezadmin_code", "errorCode": "MASTER_KEY_REQUIRED", "message": "상품코드가 비어 있습니다." }] }` | `INVALID_FILE_EXTENSION`, `INVALID_COLUMNS` |
| POST | `/api/v1/masters/products/uploads/{uploadId}/apply` | 검사된 상품 마스터 업로드에서 실패 행을 제외하고 정상 행만 upsert | ADMIN | Query: `tenantId` | `{ "uploadId": 3, "rowCount": 1200, "insertedCount": 20, "updatedCount": 15, "unchangedCount": 1160, "failedCount": 5, "status": "PARTIAL_FAILED" }` | `NOT_FOUND`, `INVALID_BATCH_STATUS` |
| POST | `/api/v1/masters/products/uploads/{uploadId}/cancel` | 검사된 상품 마스터 업로드를 반영하지 않고 취소 | ADMIN | Query: `tenantId` | `{ "uploadId": 3, "rowCount": 1200, "insertedCount": 20, "updatedCount": 15, "unchangedCount": 1160, "failedCount": 5, "status": "CANCELLED" }` | `NOT_FOUND`, `INVALID_BATCH_STATUS` |
| GET | `/api/v1/masters/products/uploads/{uploadId}/row-errors` | 상품 마스터 업로드 실패 행 상세 조회 | VIEWER | Query: `tenantId` | `[{ "rowNo": 12, "columnName": "ezadmin_code", "errorCode": "MASTER_KEY_REQUIRED", "message": "상품코드가 비어 있습니다.", "originalValue": "", "rawRow": { "ezadmin_code": "" } }]` | `NOT_FOUND` |
...
| Method | Path | 설명 | 권한 | Request Body 또는 Query Parameter | Response Body 예시 | Error Case |
|---|---|---|---|---|---|---|
| POST | `/api/v1/masters/store-routes/uploads/preview` | 배송지/차량 마스터 XLSX 업로드 파일 검사. 현재 마스터에는 아직 반영하지 않음 | ADMIN | Multipart: `file` | `{ "uploadId": 5, "rowCount": 300, "validCount": 298, "failedCount": 2, "candidateInsertedCount": 10, "candidateUpdatedCount": 8, "candidateUnchangedCount": 280, "status": "REVIEW_REQUIRED", "failures": [{ "rowNo": 8, "columnName": "baljugo_code", "errorCode": "MASTER_KEY_REQUIRED", "message": "발주고코드가 비어 있습니다." }] }` | `INVALID_FILE_EXTENSION`, `SHEET_NOT_FOUND` |
| POST | `/api/v1/masters/store-routes/uploads/{uploadId}/apply` | 검사된 배송지/차량 마스터 업로드에서 실패 행을 제외하고 정상 행만 upsert | ADMIN | Query: `tenantId` | `{ "uploadId": 5, "rowCount": 300, "insertedCount": 10, "updatedCount": 8, "unchangedCount": 280, "failedCount": 2, "status": "PARTIAL_FAILED" }` | `NOT_FOUND`, `INVALID_BATCH_STATUS` |
| POST | `/api/v1/masters/store-routes/uploads/{uploadId}/cancel` | 검사된 배송지/차량 마스터 업로드를 반영하지 않고 취소 | ADMIN | Query: `tenantId` | `{ "uploadId": 5, "rowCount": 300, "insertedCount": 10, "updatedCount": 8, "unchangedCount": 280, "failedCount": 2, "status": "CANCELLED" }` | `NOT_FOUND`, `INVALID_BATCH_STATUS` |
| GET | `/api/v1/masters/store-routes/uploads/{uploadId}/row-errors` | 배송지/차량 마스터 업로드 실패 행 상세 조회 | VIEWER | Query: `tenantId` | `[{ "rowNo": 8, "columnName": "baljugo_code", "errorCode": "MASTER_KEY_REQUIRED", "message": "발주고코드가 비어 있습니다.", "originalValue": "", "rawRow": { "baljugo_code": "" } }]` | `NOT_FOUND` |
